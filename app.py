...
EXAMPLE_CLAIMS = {
    ...
    "desc": "Moderate-risk third-party claim with multiple prior claims, delayed reporting, and elevated litigation risk. The engine routes the claim to the Legal/ADR team for early dispute resolution and settlement planning.",
